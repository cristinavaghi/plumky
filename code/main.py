cell_line_name = 'MDA-MB-231_volume' # defines the data set. current options: 'MDA-MB-231_volume' (n=66), 'lung_volume' (n=20), 'MDA-MB-231_fluorescence'
...
create_graphics             = 0 # to create summary of backward predictions
clean_backward_workspace    = 0 # to clean the folder with the results of backward predictions (only individual plots remain)
